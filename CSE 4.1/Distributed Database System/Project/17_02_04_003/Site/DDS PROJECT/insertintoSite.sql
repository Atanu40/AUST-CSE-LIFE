CREATE OR REPLACE PROCEDURE insertToSite(input_id IN list2.id%TYPE,input_name IN list2.name%TYPE,input_math IN list2.m_marks%TYPE,input_eng IN list2.e_marks%TYPE,input_res IN list2.sres%TYPE)
IS
flag int := 0;
...
BEGIN
 ...
 ELSE  
   insert into list2 values(input_id,input_name,input_math,input_eng,input_res);
   commit;  
...
CREATE OR REPLACE TRIGGER insertDataOnSite 
AFTER INSERT 
ON studentList2
DECLARE
BEGIN
